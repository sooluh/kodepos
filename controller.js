...
exports.index = async (req, res) => {
    ...
    if (keyword) {
        ...
        response.disapprove("The 'q' parameter is required", res);
    }
};

const carikodepos = (keywords) => {
    return new Promise(async (resolve, reject) => {
        ...
        await request.get({
            ...
            if (!search.length) return reject('Keyword not found');
